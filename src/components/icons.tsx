...
export function GavelIcon({ className = "w-4 h-4" }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
      <path d="M14 13l-1.5 7.5" />
      <path d="M6 6l4 4" />
      <path d="M2 2l4 4" />
      <path d="M10 10l8-8" />
      <path d="M18 2l4 4" />
...
export function DashboardLayoutIcon({ className = "w-4 h-4" }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
...
export function SolanaLogo({ className = "w-5 h-5" }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 128 128" fill="none">
      ...
      <path
        fill="url(#sol-grad)"
        d="M31.5 78.5l8.5-8.5h67.5c1.1 0 1.6 1.3.8 2.1l-17 17c-.5.5-1.1.8-1.8.8H23.3c-1.1 0-1.6-1.3-.8-2.1l8.5-8.5h.5zm-8.5-17l8.5-8.5h67.5c1.1 0 1.6 1.3.8 2.1l-17 17c-.5.5-1.1.8-1.8.8H15.3c-1.1 0-1.6-1.3-.8-2.1l8.5-8.5h.2zm67.5-25H23.3c-1.1 0-1.6-1.3-.8-2.1l8.5-8.5c.5-.5 1.1-.8 1.8-.8h67.5c1.1 0 1.6 1.3.8 2.1l-17 17c-.5.5-1.1.8-1.8.8z"
      />
    </svg>
  );
}
